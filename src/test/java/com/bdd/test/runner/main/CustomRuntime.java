...
public class CustomRuntime {
    ...
    public static CustomRuntime.Builder builder() {
        return new CustomRuntime.Builder();
    }
    ...
    public static class Builder {
        ...
        public CustomRuntime.Builder withRuntimeOptions(final RuntimeOptions runtimeOptions) {
            this.runtimeOptions = runtimeOptions;
            return this;
        }

        public CustomRuntime.Builder withClassLoader(final Supplier<ClassLoader> classLoader) {
            this.classLoader = classLoader;
            return this;
        }

        public CustomRuntime.Builder withBackendSupplier(final BackendSupplier backendSupplier) {
            this.backendSupplier = backendSupplier;
            return this;
        }

        public CustomRuntime.Builder withFeatureSupplier(final FeatureSupplier featureSupplier) {
            this.featureSupplier = featureSupplier;
            return this;
        }

        public CustomRuntime.Builder withAdditionalPlugins(final Plugin... plugins) {
            this.additionalPlugins = Arrays.asList(plugins);
            return this;
        }

        public CustomRuntime.Builder withEventBus(final EventBus eventBus) {
            this.eventBus = eventBus;
            return this;
        }

        public CustomRuntime build() {
            ...
            final ExecutorService executor = runtimeOptions.isMultiThreaded()
                    ? Executors.newFixedThreadPool(runtimeOptions.getThreads(), new CustomRuntime.CucumberThreadFactory())
                    : new CustomRuntime.SameThreadExecutorService();
            ...
            return new CustomRuntime(exitStatus, context, filter, limit, featureSupplier, executor, pickleOrder);
        }
